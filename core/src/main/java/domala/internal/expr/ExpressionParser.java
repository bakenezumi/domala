...
public class ExpressionParser extends org.seasar.doma.internal.expr.ExpressionParser{
    ...
    protected final org.seasar.doma.internal.expr.ExpressionTokenizer tokenizer;
    ...
    protected ExpressionParser(String expression, String originalExpression,
            int startPosition) {
        super(expression, originalExpression, startPosition);
        assertNotNull(expression, originalExpression);
        this.expression = expression;
        this.originalExpression = originalExpression;
        this.startPosition = startPosition;
        this.tokenizer = new ExpressionTokenizer(expression); // Domala modify
    }
    ...
    protected void parseMethodOperand() {
        ...
        if("".equals(name)) throw new RuntimeException(name);
