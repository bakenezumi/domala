...
import java.util.{Optional, function, stream}
...
object DaoRefrectionMacros {
  ...
  def getCompanion[T: c.WeakTypeTag](c: Context)(param: c.Expr[Class[T]]): c.universe.Expr[Any] = {
    import c.universe._
    reify {
  ...
  def getStreamHandlerImpl[T: c.WeakTypeTag, R: c.WeakTypeTag](c: Context)(param: c.Expr[Class[T]], f: c.Expr[Stream[T] => R], daoName: c.Expr[String], methodName: c.Expr[String]): c.universe.Expr[AbstractStreamHandler[T, R]] = {
    import c.universe._
    ...
    if (wtt.companion <:< typeOf[AbstractEntityType[_]]) {
      ...
      reify {
        ...
        new EntityStreamHandler(entity.splice.asInstanceOf[AbstractEntityType[T]],
          new function.Function[stream.Stream[T], R]() {
            def apply(p: java.util.stream.Stream[T]) = f.splice.apply(p.toScala[Stream])
          })
      }
      ...
      c.abort(c.enclosingPosition, domala.message.Message.DOMALA4245.getMessage(wtt.typeSymbol.name, daoNameText, methodNameText))
    }
  }
  ...
  def getResultListHandlerImpl[T: c.WeakTypeTag](c: Context)(param: c.Expr[Class[T]], daoName: c.Expr[String], methodName: c.Expr[String]): c.universe.Expr[AbstractResultListHandler[T]] = {
    import c.universe._
    val wtt = weakTypeOf[T]
    if (wtt.companion <:< typeOf[AbstractEntityType[_]]) {
      val entity = getCompanion(c)(param)
      ...
      val Literal(Constant(daoNameText: String)) = daoName.tree
      val Literal(Constant(methodNameText: String)) = methodName.tree
      c.abort(c.enclosingPosition, domala.message.Message.DOMALA4008.getMessage(wtt.typeSymbol.name, daoNameText, methodNameText))
    }
  }
  ...
  def getOptionalSingleResultHandlerImpl[T: c.WeakTypeTag](c: Context)(param: c.Expr[Class[T]], daoName: c.Expr[String], methodName: c.Expr[String]): c.universe.Expr[AbstractSingleResultHandler[Optional[T]]] = {
    import c.universe._
    val wtt = weakTypeOf[T]
    if (wtt.companion <:< typeOf[AbstractEntityType[_]]) {
      val entity = getCompanion(c)(param)
      ...
      val Literal(Constant(daoNameText: String)) = daoName.tree
      val Literal(Constant(methodNameText: String)) = methodName.tree
      c.abort(c.enclosingPosition, domala.message.Message.DOMALA4235.getMessage(wtt.typeSymbol.name, daoNameText, methodNameText))
    }
  }
  ...
  def getSingleResultHandlerImpl[T: c.WeakTypeTag](c: Context)(param: c.Expr[Class[T]], daoName: c.Expr[String], methodName: c.Expr[String]): c.universe.Expr[AbstractSingleResultHandler[T]] = {
    ...
    if (wtt.companion <:< typeOf[AbstractEntityType[_]]) {
      ...
      val Literal(Constant(daoNameText: String)) = daoName.tree
      val Literal(Constant(methodNameText: String)) = methodName.tree
      c.abort(c.enclosingPosition, Message.DOMA4008.getMessage(wtt.typeSymbol.name, daoNameText, methodNameText))
    }
  }
