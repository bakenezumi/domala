...
object Address extends domala.jdbc.entity.EmbeddableCompanion[Address] {
  ...
  object EmbeddableDesc extends domala.jdbc.entity.EmbeddableDesc[Address] {
    override def getEmbeddablePropertyTypes[ENTITY](embeddedPropertyName: String, entityClass: Class[ENTITY], namingType: domala.jdbc.entity.NamingType): java.util.List[domala.jdbc.entity.EntityPropertyDesc[ENTITY, _]] = {
      java.util.Arrays.asList(domala.internal.macros.reflect.EmbeddableReflectionMacros.generatePropertyDesc[Address, String, ENTITY, String](classOf[Address], "city", entityClass, embeddedPropertyName + "." + "city", namingType, true, () => new org.seasar.doma.wrapper.StringWrapper(): org.seasar.doma.wrapper.Wrapper[String], domala.Column("", true, true, false)).values.head, domala.internal.macros.reflect.EmbeddableReflectionMacros.generatePropertyDesc[Address, String, ENTITY, String](classOf[Address], "street", entityClass, embeddedPropertyName + "." + "street", namingType, true, () => new org.seasar.doma.wrapper.StringWrapper(): org.seasar.doma.wrapper.Wrapper[String], domala.Column("", true, true, false)).values.head)
    }
