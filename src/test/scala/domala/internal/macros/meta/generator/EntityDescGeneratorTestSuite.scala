...
"""
  ...
  object Person extends domala.jdbc.entity.EntityCompanion[Person] {
    ...
    object EntityDesc extends domala.jdbc.entity.AbstractEntityDesc[Person] {
      ...
      override protected val propertyDescMap: Map[String, domala.jdbc.entity.EntityPropertyDesc[Person, _]] = Seq(domala.internal.macros.reflect.EntityReflectionMacros.generatePropertyDesc[Option[ID[Person]], Person, ID[Person]](classOf[Person], "id", getNamingType, true, true, __idGenerator, false, false, false, null, domala.Column("", true, true, false)), domala.internal.macros.reflect.EntityReflectionMacros.generatePropertyDesc[Option[Name], Person, Name](classOf[Person], "name", getNamingType, false, false, __idGenerator, false, false, false, null, domala.Column("", true, false, false)), domala.internal.macros.reflect.EntityReflectionMacros.generatePropertyDesc[Option[Int], Person, Integer](classOf[Person], "age", getNamingType, false, false, __idGenerator, false, false, true, () => new org.seasar.doma.wrapper.IntegerWrapper(): org.seasar.doma.wrapper.Wrapper[Integer], domala.Column("", true, true, false)), domala.internal.macros.reflect.EntityReflectionMacros.generatePropertyDesc[Address, Person, Address](classOf[Person], "address", getNamingType, false, false, __idGenerator, false, false, false, null, domala.Column("", true, true, false)), domala.internal.macros.reflect.EntityReflectionMacros.generatePropertyDesc[Option[Int], Person, Integer](classOf[Person], "departmentId", getNamingType, false, false, __idGenerator, false, false, true, () => new org.seasar.doma.wrapper.IntegerWrapper(): org.seasar.doma.wrapper.Wrapper[Integer], domala.Column("", true, true, false)), domala.internal.macros.reflect.EntityReflectionMacros.generatePropertyDesc[Option[Int], Person, Integer](classOf[Person], "version", getNamingType, false, false, __idGenerator, true, false, true, () => new org.seasar.doma.wrapper.IntegerWrapper(): org.seasar.doma.wrapper.Wrapper[Integer], domala.Column("", true, true, false))).flatten.toMap
